...
interface ICategoryHistoryPagination {
  currentPage: number;
  setCurrentPage: Dispatch<SetStateAction<number>>;
  pageCount: number | undefined;
  currentRows: Expense[] | undefined;
  allUsers: Expense[] | undefined;
  rowsPerPage: number;
...
const CategoryHistoryPagination: FC<ICategoryHistoryPagination> = ({
  currentPage,
  setCurrentPage,
  pageCount,
  currentRows,
...
export default CategoryHistoryPagination;
